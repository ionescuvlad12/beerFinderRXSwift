...
final class Cache<T: Encodable>: AbstractCache where T == T.Encoder.DomainType {
    ...
    private let cacheScheduler = SerialDispatchQueueScheduler(internalSerialQueueName: "com.BeerFinderIonescuVlad.Network.Cache.queue")
    ...
    func save(object: T) -> Completable {
        return Completable.create { (observer) -> Disposable in
            ...
            let path = url.appendingPathComponent(self.path)
                .appendingPathComponent("\(object.imgURL)")
