...
extension Reactive where Base: NSManagedObjectContext {
     ...
     */
       // warning is caused by swift bug https://bugs.swift.org/browse/SR-5072s
   ...
   // warning is caused by swift bug https://bugs.swift.org/browse/SR-5072
    func sync<C: CoreDataRepresentable, P: Persistable>(entity: C,
                update: @escaping (P) -> Void) -> Observable<P> where C.CoreDataType == P {
        let predicate: NSPredicate = P.primaryAttribute == entity.imgURL
